package com.module.framework.widget.dialog;
...
public class SVProgressDefaultView extends LinearLayout {
    ...
    private int resInfo = R.drawable.svstatus_info;
    private int resSuccess = R.drawable.svstatus_success;
