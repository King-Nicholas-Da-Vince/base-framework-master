...
import com.module.framework.utils.KLog;
import com.module.framework.utils.ToastUtils;
import com.module.framework.utils.Utils;
...
public abstract class ApiDisposableObserver<T> extends DisposableObserver<T> {
    ...
    public void onNext(Object o) {
        ...
        ResultEntity resultEntity= (ResultEntity) baseResponse.getResult();
...
//                //请求失败，不打印Message
//                KLog.e("请求失败");
//                ToastUtils.showShort("错误代码:", resultEntity.getCode());
//                break;
